...
proto.restaurant.AddRestaurantReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    address: (f = msg.getAddress()) && proto.restaurant.Address.toObject(includeInstance, f),
    paymentModesList: (f = jspb.Message.getRepeatedField(msg, 10)) == null ? undefined : f,
    timingsList: jspb.Message.toObjectList(msg.getTimingsList(),
    proto.restaurant.Timings.toObject, includeInstance),
 ...
 * @return {!Array<!proto.restaurant.PaymentMode>}
 */
proto.restaurant.AddRestaurantReq.prototype.getPaymentModesList = function() {
  return /** @type {!Array<!proto.restaurant.PaymentMode>} */ (jspb.Message.getRepeatedField(this, 10));
};
 ...
 * @return {!proto.restaurant.AddRestaurantReq} returns this
 */
proto.restaurant.AddRestaurantReq.prototype.setPaymentModesList = function(value) {
 ...
 * @return {!proto.restaurant.AddRestaurantReq} returns this
 */
proto.restaurant.AddRestaurantReq.prototype.addPaymentModes = function(value, opt_index) {
 ...
 * @return {!proto.restaurant.AddRestaurantReq} returns this
 */
proto.restaurant.AddRestaurantReq.prototype.clearPaymentModesList = function() {
  return this.setPaymentModesList([]);
};
